...
function GenerateAI() {
  ...
  return (
    <>
      <Box sx={{ backgroundColor: 'black', minHeight: '100vh', display: 'flex', alignItems: 'end', justifyContent: 'center', color: 'white' }}>
        ...
        >
          ...
          {showImages && (
            <Box sx={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: 1, mb: 10, }}>
