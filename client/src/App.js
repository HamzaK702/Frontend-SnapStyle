...
import VirtualTryOn from './scenes/express/VirtualTryOn'; // Import VirtualTryOn component
import BodyMeasurement from './scenes/express/BodyMeasurement'; // Import BodyMeasurement component
import AIGenerator from './scenes/express/AIGenerator'; // Import AIGenerator component
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '90vh' }}>
      <Routes>
        ...
        <Route path="/virtual-try-on" element={<VirtualTryOn />} /> {/* Add route for VirtualTryOn */}
        <Route path="/body-measurement" element={<BodyMeasurement />} /> {/* Add route for BodyMeasurement */}
        <Route path="/ai-generator" element={<AIGenerator />} /> {/* Add route for AIGenerator */}
